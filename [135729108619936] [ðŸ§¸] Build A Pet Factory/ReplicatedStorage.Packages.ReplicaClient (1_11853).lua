-- Name: ReplicaClient
-- Path: game:GetService("ReplicatedStorage").Packages.ReplicaClient
-- Class: ModuleScript
-- Exploit: Xeno 
-- Time to decompile: 0.8664721000004647 seconds

-- Decompiled with Konstant V2.1, a fast Luau decompiler made in Luau by plusgiant5 (https://discord.gg/brNTY8nX8t)
-- Decompiled on 2026-02-20 08:36:09
-- Luau version 6, Types version 3
-- Time taken: 0.085281 seconds
...
local tbl_27_upvr = {}
tbl_27_upvr.__index = tbl_27_upvr
local var444_upvw
...
function ConnectionNew(arg1, arg2) -- Line 203
	...
	tbl_34.t = arg1
	tbl_34.fn = arg2
	local setmetatable_result1_4 = setmetatable(tbl_34, tbl_27_upvr)
...
function tbl_27_upvr.Disconnect(arg1) -- Line 223
	arg1.t[arg1] = nil
end
local module_3_upvr = {
	IsReady = false;
...
local function ReplicaNew_upvr(arg1, arg2) -- Line 233, Named "ReplicaNew"
	...
	tbl_26.Id = arg1
	tbl_26.Token = arg2[1]
	tbl_26.Parent = var450
	tbl_26.Children = {}
	tbl_26.BoundInstance = nil
	tbl_26.OnClientEvent = Signal_upvr.New()
	tbl_26.Maid = Maid_upvr_2.New(tbl_4_upvr)
	tbl_26.self_creation = arg2
	tbl_26.write_lib = var449
	tbl_26.set_listeners = {}
	tbl_26.write_listeners = {}
	tbl_26.changed_listeners = {}
	local setmetatable_result1_2 = setmetatable(tbl_26, module_3_upvr)
	if var450 ~= nil then
...
local function BreadthCreationSort_upvr(arg1, arg2, arg3) -- Line 637, Named "BreadthCreationSort"
	...
	-- KONSTANTERROR: [13] 9. Error Block 89 start (CF ANALYSIS FAILED)
	for _, v_11 in ipairs(arg1) do
		for i_24, v_12 in pairs(v_11) do
			...
			local _4_5 = v_12[4]
			if _4_5 == 0 or tbl_23.Id == arg2 then
				table.insert(tbl_18, tbl_23)
			elseif v_11[tostring(_4_5)] ~= nil then
				local var667 = tbl_17[_4_5]
				if var667 == nil then
					var667 = {}
					tbl_17[_4_5] = var667
				end
				table.insert(var667, tbl_23)
			else
				table.insert(tbl_3, tbl_23)
			end
		end
		local _
	end
	table.sort(tbl_18, function(arg1_8, arg2_6) -- Line 688
		local var670
	...
	for i_25, v_13 in ipairs(tbl_18) do
	...
	if #tbl_3 ~= 0 then
		...
		warn(`[{i_25}]: GROUP REPLICATION ERROR - Missing parents for:\n`..`[Id:{v_13.Id};ParentId:{SelfCreation[4]};Token:{SelfCreation[1]};Tags:{{var678}}]\n`..i_26.."Traceback:\n"..debug.traceback())
	end
	do
		return {}
	end
	-- KONSTANTERROR: [13] 9. Error Block 89 end (CF ANALYSIS FAILED)
end
